...
class CharacterDetailDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dialogWidth = width < 400 ? width * 0.98 : width < 600 ? 360 : 420;
    return Stack(
      children: [
                            ...
                            child: character.image?.isNotEmpty == true
                                ? Image.network(
                                    ...
                                    errorBuilder: (context, error, stackTrace) =>
                                        Icon(Icons.person, size: 90, color: Colors.grey.shade400),
                                  )
                                : Icon(Icons.person, size: 90, color: Colors.grey.shade400),
                          ),
                        ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(child: Text(value, style: const TextStyle(fontWeight: FontWeight.w400, color: Colors.black54))),
        ],
      ),
    );
  }
